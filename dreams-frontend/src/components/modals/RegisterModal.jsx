...
const RegisterModal = ({ isOpen, onClose, onSuccess, showLoginLink = true }) => {
  ...
  return (
    ...
    >
      <div className="space-y-6">
        <p className="text-gray-600">Sign up to start planning your dream event.</p>
        ...
        {showLoginLink && (
          <div className="text-center pt-4 border-t border-gray-200">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/login" className="text-primary hover:underline font-medium" onClick={onClose}>
                Login
              </Link>
            </p>
          </div>
