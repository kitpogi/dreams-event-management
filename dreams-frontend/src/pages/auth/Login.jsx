  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      if (userData.role === 'admin' || userData.role === 'coordinator') {
        ...
        // Always redirect clients to their dashboard after login
        navigate('/dashboard', { replace: true });
      }
    } else {
            ...
            <div className="flex flex-col flex-1 w-full md:w-1/2 p-8 sm:p-12">
              ...
              <div className="flex flex-wrap justify-between gap-3 mb-6">
                <div className="flex w-full flex-col gap-2">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 text-base font-normal leading-normal">Login to continue managing your events.</p>
                </div>
              </div>
