...
import { MainLayout, AdminLayout, ClientLayout } from './components/layout';
        ...
        <NotificationProvider>
          ...
          >
            <Routes>
              ...
              {/* Client dashboard routes - keep sidebar visible */}
              <Route
                ...
                element={
                  <ClientLayout>
                    <ErrorBoundary showContact>
                      <ProtectedRoute>
                        <LazyRoute component={LazyRoutes.ClientPackages} />
                      </ProtectedRoute>
                    </ErrorBoundary>
                  </ClientLayout>
                }
              ...
              <Route
                ...
                element={
                  <ClientLayout>
                    <ErrorBoundary showContact>
                      <ProtectedRoute>
                        <LazyRoute component={LazyRoutes.ClientPayments} />
                      </ProtectedRoute>
                    </ErrorBoundary>
                  </ClientLayout>
                }
              ...
              <Route
                ...
                element={
                  <ClientLayout>
                    <ErrorBoundary showContact>
                      <ProtectedRoute>
                        <LazyRoute component={LazyRoutes.ClientRecommendations} />
                      </ProtectedRoute>
                    </ErrorBoundary>
                  </ClientLayout>
                }
              ...
              <Route
                ...
                element={
                  <ClientLayout>
                    <ErrorBoundary showContact>
                      <ProtectedRoute>
                        <LazyRoute component={LazyRoutes.ClientReviews} />
                      </ProtectedRoute>
                    </ErrorBoundary>
                  </ClientLayout>
                }
              ...
              {/* OAuth Callback Routes - must be before other auth routes */}
              <Route path="/auth/facebook/callback" element={<LazyRoute component={LazyRoutes.FacebookCallback} />} />
