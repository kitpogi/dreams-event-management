        ...
        <div class="content">
            ...
            @if($newStatus === 'Approved')
                <div class="message approved">
                    ...
                    Your event is now confirmed. We're excited to help make your event a success. Our team will be in touch
                    with you soon to discuss the next steps and finalize the details.
                </div>
            @elseif($newStatus === 'Completed')
                <div class="message completed">
                    <strong>✨ Event Completed!</strong><br>
                    We hope your event was everything you dreamed of! Thank you for choosing D'Dreams Event & Styles. We'd
                    love to
                    hear about your experience and would appreciate any feedback you can provide.
                </div>
            @elseif($newStatus === 'Cancelled')
                <div class="message cancelled">
                    ...
                    @if($reason)
                        {{ $reason }}
                    @else
                        Your booking has been cancelled. If you have any questions or would like to reschedule, please don't
