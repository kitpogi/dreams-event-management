...
<head>
    ...
    <style>
        ...
        .message { background-color: #e3f2fd; padding: 14px; border-left: 4px solid #4a90e2; border-radius: 4px; margin: 18px 0; }
        .details { background-color: #f9f9f9; padding: 18px; border-radius: 6px; margin: 18px 0; }
...
<body>
    <div class="container">
        ...
        <p>Thank you for reaching out to Dreams Events! We’ve received your inquiry and our team will contact you soon.</p>

        <div class="message">
            <strong>What happens next?</strong><br>
            We’ll review your details and follow up to confirm availability and discuss your event requirements.
        </div>

        <div class="details">
            <div class="detail-row">
                <span class="label">Event Type</span>
                <span class="value">{{ $inquiry->event_type }}</span>
            </div>
            ...
            <div class="detail-row">
                ...
                <span class="value">{{ $inquiry->preferred_venue }}</span>
            </div>
        ...
        <p>If you need to update any details, just reply to this email. We’re excited to help make your event a success!</p>
